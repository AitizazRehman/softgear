<template>
  <v-form ref="form" @submit.prevent="submit" lazy-validation v-model="valid">
    <v-text-field label="Email" v-model="form.email" type="email" :error-messages="errors.email"
      :rules="[rules.required('email')]" :disabled="loading" prepend-icon="person"
      @input="clearErrors('email')"></v-text-field>
    ...
    <v-text-field :label="labels.password" v-model="form.password"
      ...
      :error-messages="errors.password" :disabled="loading" :rules="[rules.required('password')]" prepend-icon="lock"
